...
/*   Updated: 2023/02/21 11:18:11 by bfaure           ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */
...
void	loop2(t_data *data)
{
	...
	if (dis_left > 32 && data->player_dirx == -4)
	{
	...
	if (dis_right > 0 && data->player_dirx == 4)
	{
...
int	loop1(t_data *data)
{
	...
	if (dis_up > 32 && data->player_diry == -4)
	{
	...
	if (dis_down > 0 && data->player_diry == 4)
	{
